// Vendored from rustls-platform-verifier-android 0.1.1.
// Upstream commit: 1099f161bfc5e3ac7f90aad88b1bf788e72906cb.
// Licensed under MIT; see this module's LICENSE-MIT.
    ...
    private fun verifyCertificateChain(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            revocationChecker.options = EnumSet.of(
                ...
                // Let's Encrypt certificates no longer advertise OCSP. Ask
                // Android for the CRL directly instead of failing before its
                // documented OCSP-to-CRL fallback can run.
